...
const routes: Routes = [
    {
        ...
        children: [
            ...
            { path: 'promesas', component: PromesasComponent, data: { titulo: 'Productos' }},
            { path: 'rxjs', component: RxjsComponent, data: { titulo: 'Eventos' }},
            { path: 'perfil', component: PerfilComponent, data: { titulo: 'Perfil de Usuario'}},

              // Mantenimientos
            { path: 'usuarios', component: UsuariosComponent, data: { titulo: 'Pacientes'}},
            { path: 'citas', component: CitasComponent, data: { titulo: 'Citas'}},
            { path: 'medicos', component: MedicosComponent, data: { titulo: 'Médicos'}},
            { path: 'mascotas', component: MascotasComponent, data: { titulo: 'Mascotas'}},
            { path: 'razas', component: RazasComponent, data: { titulo: 'Razas'}},
